...
let textLines = [
  "He travelled to Earth, the fifth planet on his journey.",
  "Then he looked down and saw a beautiful yellow snake on the sand.",
];
  ...
  if (img && img.width > 0 && img.height > 0) {
    ...
    for (let y = 0; y < h; y++) {
      for (let x = 0; x < w; x++) {
        ...
        let wave = sin(frameCount * animationSpeed + x * 0.1 + y * 0.1) * 30;
